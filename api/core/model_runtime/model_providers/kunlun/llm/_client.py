...
class KunLunLLMClient:
    def __init__(self, model: str, app_id: str, api_key: str, api_secret: str, endpoint_url: Optional[str] = None, assistant_code: Optional[str] = None):
    ...
    def create_url(self, host: str, path: str, api_base: str, api_key: str, api_secret: str) -> str:
        ...
        authorization_origin = (
            f'hmac api_key="{api_key}", algorithm="hmac-sha256", headers="host date request-line",'
